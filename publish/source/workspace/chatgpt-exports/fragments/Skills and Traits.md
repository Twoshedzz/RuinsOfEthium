...
**DODGE (ACTIVE)** ![](Skills%20and%20Traits/elite_skill_small.jpg)
Once per Turn, this player may re-roll a single Agility Test when attempting to Dodge. Additionally, this Skill will impact the Stumble result when an opposition player performs a Block Action against this player, as described on [page 62](https://bloodbowlbase.ru/bb2025/core_rules/the_game_of_blood_bowl/#stumble).
**DEFENSIVE (ACTIVE)**
...
**LEAP (ACTIVE)**
During their Move Action, a player with this Skill can attempt to Leap over a single adjacent square regardless of what is in the square. Leaping works the same way as Jumping, as described on [page 56](https://bloodbowlbase.ru/bb2025/core_rules/the_game_of_blood_bowl/#jumping-over-players), with the exception that the Leaping player may reduce the negative modifiers they would receive by Leaping by 1, to a minimum of -1.
...
GENERAL
**BLOCK (ACTIVE)** ![](Skills%20and%20Traits/elite_skill_small_2.jpg)
...
**GUARD (ACTIVE)** ![](Skills%20and%20Traits/elite_skill_small_3.jpg)
...
**MIGHTY BLOW (ACTIVE)** ![](Skills%20and%20Traits/elite_skill_small_4.jpg)
...
![](Skills%20and%20Traits/ball_and_chain.jpg)
...
![](Skills%20and%20Traits/bombardier.jpg)
...
**POGO (ACTIVE)**
During their movement, a player with this Trait can attempt to Pogo over a single adjacent square regardless of what is in the square. Pogoing works the same way as Jumping, as described on [page 56](https://bloodbowlbase.ru/bb2025/core_rules/the_game_of_blood_bowl/#jumping-over-players), with the exception that the Pogoing player may ignore all negative modifiers they would receive by Jumping.
...
A player with this Trait is more prone to injury and so if an Injury Roll is made for them, roll on the [Stunty Injury Table](https://bloodbowlbase.ru/bb2025/core_rules/the_game_of_blood_bowl/#stunty-injury-table) instead.
**SWOOP (ACTIVE)**
...
This player may declare the Throw Team-mate Action as described on [page 76](https://bloodbowlbase.ru/bb2025/core_rules/the_game_of_blood_bowl/#throw-team-mate-actions).
**TIMMM-BER! (PASSIVE)**
