...
As described on [page 94](https://bloodbowlbase.ru/bb2025/core_rules/league_play/#inducements), Inducements in League Play are purchased using Petty Cash, a team's Treasury, or sometimes a mixture of both. Working out what Inducements a team can take is done during the Pre-game Sequence.
**INDUCEMENTS IN MATCHED PLAY AND EXHIBITION PLAY**
As described on [page 110](https://bloodbowlbase.ru/bb2025/core_rules/matched_play/#inducements-in-matched-play) and [page 116](https://bloodbowlbase.ru/bb2025/core_rules/exhibition_play/#drafting-an-exhibition-play-team), Inducements in Matched Play and Exhibition Play are purchased out of a team's Team Draft Budget.
...
* 0-3 [Prayers to Nuffle](https://bloodbowlbase.ru/bb2025/core_rules/inducements/#0-3-prayers-to-nuffle) - 10,000 gold pieces
* 0-5 [Part-time Assistant Coaches](https://bloodbowlbase.ru/bb2025/core_rules/inducements/#0-5-part-time-assistant-coaches) - 20,000 gold pieces
* 0-5 [Temp Agency Cheerleaders](https://bloodbowlbase.ru/bb2025/core_rules/inducements/#0-5-temp-agency-cheerleaders) - 5,000 gold pieces
* 0-1 [Team Mascot](https://bloodbowlbase.ru/bb2025/core_rules/inducements/#0-1-team-mascot) - 25,000 gold pieces
* 0-1 [Weather Mage](https://bloodbowlbase.ru/bb2025/core_rules/inducements/#0-1-weather-mage) - 25,000 gold pieces
* 0-2 [Blitzer's Best Kegs](https://bloodbowlbase.ru/bb2025/core_rules/inducements/#0-2-blitzers-best-kegs) - 50,000 gold pieces
* 0-3 [Bribes](https://bloodbowlbase.ru/bb2025/core_rules/inducements/#0-3-bribes-0-6-for-teams-with-the-bribery-and-corruption-special-rule) (0-6 for teams with the Bribery and Corruption special rule) - 100,000 gold pieces (50,000 gold pieces for teams with the Bribery and Corruption special rule)
* 0-8 [Extra Team Training](https://bloodbowlbase.ru/bb2025/core_rules/inducements/#0-8-extra-team-training) - 100,000 gold pieces
* 0-1 [Mortuary Assistant](https://bloodbowlbase.ru/bb2025/core_rules/inducements/#0-1-mortuary-assistant) - 100,000 gold pieces (teams with the Masters of Undeath special rule only)
* 0-1 [Plague Doctor](https://bloodbowlbase.ru/bb2025/core_rules/inducements/#0-1-plague-doctor) - 100,000 gold pieces (teams with the Favoured of Nurgle special rule only)
* 0-1 [Riotous Rookies](https://bloodbowlbase.ru/bb2025/core_rules/inducements/#0-1-riotous-rookies) - 150,000 gold pieces (teams with the Low Cost Linemen special rule only)
* 0-2 [Wandering Apothecary](https://bloodbowlbase.ru/bb2025/core_rules/inducements/#0-2-wandering-apothecary) - 100,000 gold pieces (not available to teams that cannot hire an Apothecary)
* 0-1 [Halfling Master Chef](https://bloodbowlbase.ru/bb2025/core_rules/inducements/#0-1-halfling-master-chef) - 300,000 gold pieces (100,000 gold pieces for Halfling teams)
* 0-1 [Biased Referee](https://bloodbowlbase.ru/bb2025/core_rules/inducements/#0-1-biased-referee) - price varies
* 0-1 [Infamous Coaching Staff](https://bloodbowlbase.ru/bb2025/core_rules/inducements/#0-1-infamous-coaching-staff) - price varies
* 0-3 [Mercenary Players](https://bloodbowlbase.ru/bb2025/core_rules/inducements/#0-3-mercenary-players) - price varies
* 0-2 [Star Players](https://bloodbowlbase.ru/bb2025/core_rules/inducements/#0-2-star-players) - price varies
* 0-1 [Wizard](https://bloodbowlbase.ru/bb2025/core_rules/inducements/#0-1-wizard) - price varies
...
Additionally, a team with a Team Mascot can re-roll any rolls of a natural 1 when rolling the D6 for the Cheering Fans result on the [Kick-off Event Table](https://bloodbowlbase.ru/bb2025/core_rules/the_game_of_blood_bowl/#kick-off-event-table).
0-1 WEATHER MAGE
**25,000 GOLD PIECES, AVAILABLE TO ANY TEAM**
Once per game, at the start of any of your Turns, you may immediately make a roll on the [Weather Table](https://bloodbowlbase.ru/bb2025/core_rules/the_game_of_blood_bowl/#weather-table), applying a modifier of up to +2 or -2 to the roll. The resulting weather conditions are applied immediately and will last until the next time a Changing Weather result is rolled on the [Kick-off Event Table](https://bloodbowlbase.ru/bb2025/core_rules/the_game_of_blood_bowl/#kick-off-event-table).
...
The list of available Star Players can be found on [pages 193-196](https://bloodbowlbase.ru/bb2025/starplayers/). Each Star Player profile will explain which teams can hire them and how many gold pieces they will cost to hire. Additional Star Players can be found in the Star Players PDF which can be found at warhammer-community.com.
0-1 WIZARD
**PRICE VARIES, AVAILABLE TO ANY TEAM**
...
|  | 5 | 1 | 2+ | 5+ | 9+ | [Dodge](https://bloodbowlbase.ru/bb2025/core_rules/skills_and_traits/#dodge-active), [Leap](https://bloodbowlbase.ru/bb2025/core_rules/skills_and_traits/#leap-active), [No Ball](https://bloodbowlbase.ru/bb2025/core_rules/skills_and_traits/#no-ball-passive), [Stunty](https://bloodbowlbase.ru/bb2025/core_rules/skills_and_traits/#stunty-passive), [Titchy](https://bloodbowlbase.ru/bb2025/core_rules/skills_and_traits/#titchy-passive), [Very Long Legs](https://bloodbowlbase.ru/bb2025/core_rules/skills_and_traits/#very-long-legs-active) |
