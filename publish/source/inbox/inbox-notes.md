...
See **[INVENTORY.md](INVENTORY.md)** for campaign synthesis.
...
## Filed out of inbox (canonical copies)
...
| Session PDFs | `session-plans/pdfs/` |
| PC sheets | `characters/sheets/` |

Original `Hellfire/` folder in inbox kept as archive.
