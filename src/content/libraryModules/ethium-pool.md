---
title: "Ethium pool (tower + dungeon + pool)"
order: 4
summary: "Ruined tower, Hammer camp, Garnel rescue, undead wizard, healing pool hub."
published: true
---

# Module — Ethium pool (tower + dungeon + pool)

**Status:** Ready to run. Pool can remain an active hub; east tunnels bridge to [`duergar-outpost.md`](/dm/modules/duergar-outpost/).

**Canonical PDFs:** [`ethium_full_session_module_v2.pdf`](/dm/pdfs/ethium_full_session_module_v2.pdf)  · ritual / language: [`ethium_language_sheet.pdf`](/dm/pdfs/ethium_language_sheet.pdf) · Session 3 creature sheet: [`session3_stat_blocks_landscape_a4.pdf`](/dm/pdfs/session3_stat_blocks_landscape_a4.pdf)

---

## Overview

Ruined tower on the Ethium plateau — Hammer surface camp, spiral stairs into Ethium stonework, alcove undead, Garnel’s captivity chamber, maul trap, then the **pool chamber**. Undead wizard (corrupted investigator) + zombies; on death the wizard can explode with Ethium energy. Garnel can help configure **Ethium stones** so the **healing pool** activates (water from a source elsewhere).
...
**Healing (prep):** once per rest, each PC regains **1d6 HP**. Drinking / lingering may cause whispers, dream-flashes, or a corruption mark. Ritual levels: [healing-pool-ritual](/dm/world/places/healing-pool-ritual/).
...
|----------|----|----|--------|-------|
| Gang Thug | 12 | 11 | Club +3, 1d6+1 | Reckless |
...
Undead Ethium wizard + 2 zombies; wizard explodes on death. CYOA `ethium-pool-wizard` (Deadly). Mage’s spell list (Kevarch book): [healing-pool-ritual](/dm/world/places/healing-pool-ritual/). No separate AC/HP block in Session 3 PDF — run from that list + zombie open rules.
...
Otyugh from Troglodyte tracker: **AC 14 · HP 75 · Bite +6 (2d8+3), Tentacle +6 · Grapple DC 13 · Foul Sludge Spray 1/enc**. Full east path: [`duergar-outpost.md`](/dm/modules/duergar-outpost/).
...
|-------|-----------|-----------|
| Pool dungeon | ![ethium-pool-dungeon.png](/dm/maps/ethium-pool-dungeon.png) | `ethium-pool-dungeon.png` |
| Hand-drawn pool | ![ethium-pool-handdrawn.jpg](/dm/maps/ethium-pool-handdrawn.jpg) | `ethium-pool-handdrawn.jpg` |
| Beyond the pool | ![beyond-the-pool.png](/dm/maps/beyond-the-pool.png) | `beyond-the-pool.png` |
| Ruined tower (surface) | ![ruined-tower.jpg](/dm/maps/ruined-tower.jpg) | `ruined-tower.jpg` |
| Plateau (Tobbs) | ![ethium-plateau.jpg](/dm/maps/ethium-plateau.jpg) | `ethium-plateau.jpg` |
...
| Who | Role |
|-----|------|
| [`garnel-stoneblender.md`](/dm/world/characters/garnel-stoneblender/) | Captive; can activate pool; may stay researching |
...
| Kind | Where |
|------|--------|
| Session notes | [session-03](/dm/notes/session-03/) (Parts 5+) |
| Session plan | [session-plan-ethium-pool-module.md](../../session-plans/session-plan-ethium-pool-module.md) |
| Chapter draft | [06-east-of-the-pool.md](../../chapter-drafts/06-east-of-the-pool.md) |
| Novel | [05-the-ruined-tower.md](../../../chapters/05-the-ruined-tower.md) |
| CYOA | [flow](/cyoa/flow/) (85–120) |
| Place | [ethium](/dm/world/places/ethium/) · [healing-pool-ritual](/dm/world/places/healing-pool-ritual/) |
| Related modules | [`kruthik-lair.md`](/dm/modules/kruthik-lair/) · [`duergar-outpost.md`](/dm/modules/duergar-outpost/) · [`journey-to-ethium.md`](/dm/modules/journey-to-ethium/) |
