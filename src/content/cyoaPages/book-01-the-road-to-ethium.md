---
title: "Book 1 — The Road to Ethium"
order: 4
summary: "*A choose-your-own-adventure reworking of the published story so far.* *You are Thorn Axehand, a blue-skinned half-orc fighter. Your companions are Derek (dw…"
published: true
---
...
See [`FORMAT.md`](/cyoa/format/) for markup rules and [`encounters.md`](/cyoa/encounters/) for combat ids.
...
Nibbles claims a finely made **hand axe** etched with an Ethium rune. The metal is sound; the magic sleeps.

**Gain:** rune hand axe (dormant)
